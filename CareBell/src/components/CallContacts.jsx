      ...
      <div className="relative flex items-center mb-4">
        ...
        {!isAdding ? (
          <button
            ...
            className="absolute right-0 -right-0 flex items-center bg-blue-900 hover:bg-blue-700 text-white font-semibold text-sm rounded-lg px-3 py-2 transition"
          >
            Add Contact
          </button>
        ) : (
